            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        ...
                        <li>
                                <Link to='/studentRecord' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="StudentRecord">
                                    {/* foam */}
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="2" fill="none" stroke="currentColor" className="size-4 inline-block">
                                        <circle cx="12" cy="7" r="3"></circle>
                                        <path d="M5 20c0-4 3-6 7-6s7 2 7 6"></path>
                                    </svg>
                                    <span className="is-drawer-close:hidden">Student Record</span>
                                </Link>
                        </li>
                        <li>

    ...
    <div className='borde2 m-4 bg-[#f8f8f8] rounded' >
      ...
      <form onSubmit={onSubmithandle}
        ...
        <div>
          ...
          <input required className="bg-white p-2 rounded outline-none border-2 border-gray-300 w-full my-1" placeholder="Last Name" type="text" />
        </div>
        <div className="" >
        ...
        <div className="" >
          <label htmlFor="" className="font-semibold">Employee ID</label>
          <input required className="p-2 rounded outline-none border-2 border-gray-300 w-full my-1" placeholder="Employee ID" type="email" />
        </div>
        ...
        <div className="" >
          <label htmlFor="" className="font-semibold">Joining Date</label>
          <input required className="p-2 rounded outline-none border-2 border-gray-300 w-full my-1" placeholder="41303-1586080-9" type="date" />
        </div>

        <div className="" >
          <label htmlFor="" className="font-semibold">Salary</label>
          <input required className="p-2 rounded outline-none border-2 border-gray-300 w-full my-1" placeholder="Min-25000" type="number" />
        </div>
        ...
        <button className=" col-span-4 active:scale-95 transition-all hover:bg-blue-600  text-white text-lg w-1/10 my-3 py-2 rounded bg-blue-500">Sumbit</button>
      </form>
